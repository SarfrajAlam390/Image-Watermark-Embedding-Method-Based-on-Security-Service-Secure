...
#progress
{
	...
	<body>
	<%ArrayList<Bean> al = (ArrayList)session.getAttribute("contrast");%>
		<div class="wrapper">
			<!-- header -->
			...
			<div class="main-content">
				<div class="container">
					...
					<div class="login-area">
						...
						%>
						<!-- paragraph -->
						<form action="./AmpletudeImageServlet_user" method="post" role="form" id="login-form">
                    ...
                    <%if(al.isEmpty()){ %>
                        ...
                        for(Bean b:al){
                        	i++;
                        	session.setAttribute(i + "img", b.getContrastImage());
                        %>
                        ...
                        for(Bean b:al){
                        	j++;
                        	session.setAttribute(j + "img1", b.getEncryptcontrastImage());
                        %>
                        ...
                        <%} %>
							...
							<button type="submit" class="btn btn-warning" onclick="onc();">Similarity Measurement</button>
						</form>
	...
	function onc()
	{
		...
		function frame()
		{
			...
			if(width>=20 && width<=60)
				{
					val.innerHTML="Apply High-Order Gradent Magnitude";
				}
				if(width>=61 && width<=100)
				{
					val.innerHTML="Multi Log-Gabor Filters";
				}
			if(width>=100)
			{
				clearInterval(id);
