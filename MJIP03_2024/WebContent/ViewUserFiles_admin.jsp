...
<html>
	...
	<body>
	<%
	ArrayList<Bean> al = new ViewDAO().adminViewUploadedFiles(); %>
		<div class="wrapper">
			<!-- header -->
			...
			<div class="main-content">
              ...
              <th style="color: blue; font-family: Times New Roman; padding: 20px;">Fid</th>
              <th style="color: blue; font-family: Times New Roman; padding: 20px;"> IIBVSI</th>
              ...
              <td style="color: red; font-family: Times New Roman; padding: 20px;"><%=b.getFid() %></td>
              <td style="color: red; font-family: Times New Roman; padding: 20px;"><%=b.getPercentage()%></td>
              <td style="color: red; font-family: Times New Roman; padding: 20px;"><a href="./ViewFile_admin.jsp?uid=<%=b.getUid()%>&fid=<%=b.getFid()%>">View</a></td>
              </tr>
              <%} %>
              </table>
							</div>
