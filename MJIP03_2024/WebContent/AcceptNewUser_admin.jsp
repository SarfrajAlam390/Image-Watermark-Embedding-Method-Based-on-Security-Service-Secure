...
<html>
	...
	<body>
	<%ArrayList<Bean> al = new ViewDAO().adminAcceptNewUser(); %>
		<div class="wrapper">
			<!-- header -->
			...
			<div class="main-content">
              ...
              <th style="color: blue; font-family: Times New Roman; padding: 20px;">Active</th>
              ...
              <td style="color: red; font-family: Times New Roman; padding: 20px;"><a href="./AcceptNewUserServlet?uid=<%=b.getUid()%>" sty>Activate</a></td>
              </tr>
              <%} %>
              </table>
							</div>
							<%}else{ %>
							<div class="form-group">
								<h3>New User Requests are Not Available</h3>
							</div>
							<%} %>
					</div>
				</div>
