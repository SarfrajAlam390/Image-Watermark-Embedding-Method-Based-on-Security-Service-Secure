	...
	<%ArrayList<Bean> al = new ViewDAO().adminViewFeedback(); %>
		<div class="wrapper">
			...
			<div class="main-content">
              ...
              <th style="color: blue; font-family: Times New Roman; padding: 20px;">Feedback</th>
              ...
              <td style="color: red; font-family: Times New Roman; padding: 20px;"><textarea rows="4" cols="4"><%=b.getAddress()%></textarea></td>
              </tr>
              <%} %>
              </table>
							</div>
							<%}else{ %>
							<div class="form-group">
								<h3>Feedbacks are Not Available</h3>
							</div>
							<%} %>
					</div>
				</div>
